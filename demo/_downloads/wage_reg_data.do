** This do file is to generate wage regression residuals **
** Date: May 18, 2014 
** Author: Guang Zuo
*********************************************************************************************************************
* 1. import the data
...
** 2.6 exclude those who have retired
drop if empstatus == 3 & year <= 1975
drop if empstatus == 4 & year >= 1976
...
*********************************************************************************************************************
* 4. wage regression
** 4.1 generate log wage variable
